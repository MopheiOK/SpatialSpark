...
class SMapPartition[K, V](protected val data: HashMap[K, V])(
  override implicit val kTag: ClassTag[K],
  override implicit val vTag: ClassTag[V])
    extends SpatialRDDPartition[K, V] with LazyLogging {
   ...
   */
  def sjoin[U: ClassTag](other: SpatialRDDPartition[K, U])(f: (K, V) => V): SpatialRDDPartition[K, V] = sjoin(other.iterator)(f)
   ...
   * the f function apply to the value of the filter condition
   */
  def sjoin[U: ClassTag](other: Iterator[(K, U)])(f: (K, V) => V): SpatialRDDPartition[K, V] = {
  ...
  override def rjoin[U: ClassTag, U2: ClassTag](other: SpatialRDDPartition[K, U])(f: (Iterator[(K, V)]) => U2,
                                                                                  f2: (U2, U2) => U2): Iterator[(U, U2)] = rjoin(other.iterator)(f, f2)

  def rjoin[U: ClassTag, U2: ClassTag](other: Iterator[(K, U)])(f: (Iterator[(K, V)]) => U2,
  ...
  override def knnjoin_[U: ClassTag](other: SpatialRDDPartition[K, U], knn: Int, f1: (K) => Boolean,
                                     f2: (V) => Boolean): Iterator[(K, Double, Iterator[(K, V)])] = knnjoin_(other.iterator, knn, f1, f2)

  def knnjoin_[U: ClassTag](other: Iterator[(K, U)], knn: Int, f1: (K) => Boolean,
...
private[spatialrdd] object SMapPartition {
  ...
  def apply[K: ClassTag, U: ClassTag, V: ClassTag](iter: Iterator[(K, V)], z: (K, U) => V, f: (K, V, U) => V): SpatialRDDPartition[K, V] =
    {
